...
struct filter_rule_cfg
{
    ...
    // If set, requires the packet's payload to match this game's real
    // protocol signature (see common/games.h and xdp/utils/games.h). Names
    // are case-insensitive: rust, fivem, source_engine, minecraft_be, samp, ts3.
    char* game;
